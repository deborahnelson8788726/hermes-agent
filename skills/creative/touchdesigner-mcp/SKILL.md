...
description: "Управление запущенным TouchDesigner через twozero MCP — создание операторов, настройка параметров, подключение, выполнение Python, построение реального времени визуалов. 36 нативных инструментов."
version: 1.1.0
